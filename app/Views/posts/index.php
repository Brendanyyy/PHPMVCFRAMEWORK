        ...
        <div class="card">
            ...
            <?php if (empty($posts)): ?>
                <div class="empty-state">
                    ...
                    <a href="/posts/create" class="btn btn-primary mt-4">Create New Post</a>
                </div>
            <?php else: ?>
                <div class="mb-2">
                    ...
                    <?php foreach($posts as $p): ?>
                        <li class="post-item">
                            ...
                            <div class="post-actions">
                                <a href="/posts/<?= htmlspecialchars($p['id'] ?? '') ?>/edit" class="btn btn-secondary">Edit</a>
                                <form action="/posts/<?= htmlspecialchars($p['id'] ?? '') ?>/delete" method="POST">
